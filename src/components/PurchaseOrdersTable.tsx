            ...
            <div className="flex gap-2">
              {onViewDetails && (
                <button
                  ...
                  className="p-2 bg-brand-cta/20 text-brand-cta border border-brand-cta/50 rounded-lg hover:bg-brand-cta/30 transition-colors duration-200 flex items-center justify-center pl-2.5"
                  title="Ver Detalhes"
                >
                  <Eye size={16} />
                </button>
